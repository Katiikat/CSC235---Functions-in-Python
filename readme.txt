Assignment: Creating and using Functions in Python
...
Assignment Requirements: 
  ...
  Add at least 5 functions to your application in addition to main.
  ...
  This program should have a great user experience.
